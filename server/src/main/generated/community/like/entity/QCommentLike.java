...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 320157085L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCommentLike commentLike = new QCommentLike("commentLike");

    public final BooleanPath cLikeStatus = createBoolean("cLikeStatus");

    public final community.comment.entity.QComment comment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new community.comment.entity.QComment(forProperty("comment"), inits.get("comment")) : null;
